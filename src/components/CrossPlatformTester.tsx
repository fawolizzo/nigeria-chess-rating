  ...
  const runDiagnostics = async () => {
    ...
    try {
      ...
      logMessage(
        LogLevel.INFO,
        'CrossPlatformTester',
        `Diagnostics completed on ${platform.type}`,
        diagnosticResults
      );
  ...
  const forceDataSync = async () => {
    ...
    try {
      ...
      logMessage(
        LogLevel.INFO,
        'CrossPlatformTester',
        `Force sync initiated from ${platform.type}`
      );
      ...
      logMessage(
        LogLevel.INFO,
        'CrossPlatformTester',
        `Force sync completed on ${platform.type}`,
        { success: result }
      );
    } catch (error) {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              Test the rating system across different devices
            </CardDescription>
          </div>
          {results && (
                ...
                <div className="rounded-md bg-muted p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="font-medium">
                      {results.platform.details || 'Generic'}
                    </div>

                    <div className="text-muted-foreground">User Agent:</div>
                    <div
                      className="text-xs truncate"
                      title={results.platform.userAgent}
                    >
                ...
                <div className="rounded-md bg-muted p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {getStatusBadge(
                        results.compatibility.sessionStorageAvailable
                      )}
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {getStatusBadge(
                        results.compatibility.broadcastChannelSupport
                      )}
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      {getStatusBadge(
                        results.compatibility.serviceWorkerSupport
                      )}
                    </div>
              ...
              <div className="space-y-4 mt-4">
                <div className="rounded-md bg-muted p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="font-medium">
                      {results.storageStats.storageItemCount}
                    </div>
                    ...
                    <div className="font-medium">
                      {results.storageStats.sessionItemCount}
                    </div>
                    ...
                    <div className="font-medium">
                      {results.storageStats.estimatedStorageUsage}
                    </div>

                    <div className="text-muted-foreground">Device ID:</div>
                    <div className="font-medium">
                      {results.storageStats.deviceId}
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4 mt-4">
              <div className="rounded-md bg-muted p-4">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Test data synchronization between devices. When you click
                  "Force Sync", data will be synchronized across all instances
                  of the application.
                </p>
