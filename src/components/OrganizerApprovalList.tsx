  ...
  const handleApprove = (userId: string) => {
    try {
      ...
      toast({
        ...
        description:
          'There was an error approving the organizer. Please try again.',
        variant: 'destructive',
      });
    }
  };
  ...
  const handleReject = (userId: string) => {
    try {
      ...
      toast({
        ...
        description:
          'There was an error rejecting the organizer. Please try again.',
        variant: 'destructive',
      });
    }
  };
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-6 text-center">
            ...
            <p className="text-gray-500 mb-2">
              All organizer registrations have been processed
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Pending Organizers</CardTitle>
        <CardDescription>
          {pendingOrganizers.length} organizer
          {pendingOrganizers.length !== 1 ? 's' : ''} waiting for approval
        </CardDescription>
      </CardHeader>
      <CardContent>
