    ...
    <div className="p-6">
      <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 text-center">
        ...
        <p className="mt-2 mb-4 text-red-500 dark:text-red-300 max-w-md mx-auto">
          There was a problem loading the dashboard data. This could be due to
          network issues or data synchronization problems.
        </p>

        {errorDetails && (
          <div
            className="mt-2 mb-4 p-3 bg-red-100 dark:bg-red-900/30 rounded text-sm text-red-700 
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span>
                    <HelpCircle className="h-4 w-4 text-red-500 flex-shrink-0 mt-0.5" />
                  </span>
                </TooltipTrigger>
                <TooltipContent>
                  <p className="w-64 text-xs">
                    This error helps developers identify what went wrong. Try
                    refreshing or clearing your browser cache if this persists.
                  </p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
