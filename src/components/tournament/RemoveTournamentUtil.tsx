...
export const ResetAllData = () => {
  ...
  useEffect(() => {
    try {
      console.log(
        'Starting COMPLETE system reset from ResetAllData component...'
      );
      ...
      toast({
        ...
        description:
          'All data has been cleared including rating officers, organizers, and players. All users need to register again.',
        duration: 5000,
      });
