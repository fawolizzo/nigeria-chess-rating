      ...
      <div className="container mx-auto px-4 pt-24 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          <Alert className="mb-6">
            ...
            <AlertDescription>
              Cross-platform testing is temporarily disabled while we fix some import issues. 
              This page will be available again soon.
            </AlertDescription>
          </Alert>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Test the rating system's compatibility across different devices and browsers
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                This tool helps ensure the Nigeria Chess Rating system works consistently across:
              </p>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 dark:text-yellow-300 text-sm mt-1">
                      We're fixing some technical issues with the cross-platform testing tools. 
