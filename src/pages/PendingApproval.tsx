...
const PendingApproval = () => {
  ...
  useEffect(() => {
    ...
    logMessage(
      LogLevel.INFO,
      'PendingApproval',
      `User ${currentUser.email} is in pending state`
    );
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
          <div className="p-6 sm:p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-lg mx-auto">
              Your Tournament Organizer account is currently pending approval by
              a Rating Officer. You'll receive an email once your account has
              been approved.
            </p>
