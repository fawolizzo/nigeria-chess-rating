      ...
      <div className="w-full max-w-2xl p-8 space-y-8 bg-white dark:bg-gray-800 rounded-lg shadow-md">
        ...
        {testData && (
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
            <h3 className="text-green-800 dark:text-green-200 font-semibold">✅ Storage Test Success!</h3>
        ...
        {storageData && (
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <h3 className="text-blue-800 dark:text-blue-200 font-semibold">📊 Current Storage Data:</h3>
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{storageData.users}</div>
                <div className="text-sm text-blue-500">Users</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{storageData.players}</div>
                <div className="text-sm text-blue-500">Players</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600">{storageData.tournaments}</div>
            ...
            {storageData.users === 0 && (
              <div className="text-center">
                <p className="text-yellow-600 dark:text-yellow-400 mb-2">No test data found!</p>
                <button 
